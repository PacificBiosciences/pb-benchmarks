...
def get_args():
    ...
    parser = argparse.ArgumentParser(
        description="Process GA4GH output vcfs from truvari for a single sample")
...
class TruthStats:
    ...
    def report(self, fp):
        ...
        fp.write("TP_base_bp: {} TP_comp_bp: {} FP_bp: {} FN_bp: {}\n".format(self.tp_base_len, self.tp_comp_len, self.fp_len, self.fn_len))
